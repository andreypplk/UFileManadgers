...
//        private async Task<bool> RenameFileAsync(string oldPath, string newName)  // БЫЛО: string newPath
//        {
//            try
//            {
//                Debug.WriteLine($"RenameFileAsync: Старый путь: {oldPath}, Новое имя: {newName}");
...
//                // ВЫЧИСЛЯЕМ новый путь на основе нового имени
//                string directory = Path.GetDirectoryName(oldPath);
//                string newPath = Path.Combine(directory, newName);

//                Debug.WriteLine($"Новый полный путь: {newPath}");

//                if (File.Exists(newPath))
//                {
//                    Debug.WriteLine($"ERROR: Файл '{newName}' уже существует");
//                    return false;
//                }
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"ERROR RenameFileAsync: {ex.Message}");
//                return false;
//            }
//        }
