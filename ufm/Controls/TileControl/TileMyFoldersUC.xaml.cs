...
//            catch 
//            {
//                //Debug.WriteLine($"[TileMyFoldersUc] Îøèáêà â OnDisplayModeChanged: {ex.Message}");
//            }
//        }
...
//            catch  
//            {
//                //Debug.WriteLine($"[TileMyFoldersUc] Îøèáêà â SetElementsVisibility: {ex.Message}");
//            }
//        }
    ...
    public sealed partial class TileMyFoldersUc : BaseTileControl
    {
        ...
        private void UpdateDetailsVisibility()
        {
            ...
            switch (sizePart)
            {
                ...
                case "above medium":
                    SetElementsVisibility(true, showDetails: true, showAttributes: true);
                    if (ItemsCountText != null) ItemsCountText.FontSize = 11;
                    if (LastModifiedText != null) LastModifiedText.FontSize = 11;
                    if (AttributesText != null) AttributesText.FontSize = 11;
                    break;
                ...
                case "huge":
                    SetElementsVisibility(true, showDetails: true, showAttributes: true);
                    if (ItemsCountText != null) ItemsCountText.FontSize = 16;
                    if (LastModifiedText != null) LastModifiedText.FontSize = 16;
                    if (AttributesText != null) AttributesText.FontSize = 14;
                    break;
