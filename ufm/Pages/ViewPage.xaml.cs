...
namespace ufm
{
    public sealed partial class ViewPage : Page
    {
        ...
        private void SetViewMode(ViewMode mode, ContentControl targetControl = null, PanelManager targetManager = null)
        {
            ...
            if (newView != null)
            {
                // Универсальная обработка для всех типов TileView
                if (newView is TileViewIcons tileViewIcons)
                {
                    string panelId = managerToUse.PanelId;
                    tileViewIcons.PanelId = panelId;
                ...
                //{
                //    string panelId = managerToUse.PanelId;
                //    tileTableView.PanelId = panelId;
                //    tileTableView.SetPanelManager(managerToUse);
                //    tileTableView.NavigationChanged += TileView_NavigationChanged; // ПРАВИЛЬНОЕ ИМЯ
                //}
                //else if (newView is TileTilesView tileTilesView)
                //{
                //    string panelId = managerToUse.PanelId;
                //    tileTilesView.PanelId = panelId;
                //    tileTilesView.SetPanelManager(managerToUse);
                //    tileTilesView.NavigationChanged += TileView_NavigationChanged; // ПРАВИЛЬНОЕ ИМЯ
                //}
                //else if (newView is TileCompactListView tileCompactListView)
                //{
                //    string panelId = managerToUse.PanelId;
                //    tileCompactListView.PanelId = panelId;
                //    tileCompactListView.SetPanelManager(managerToUse);
                //    tileCompactListView.NavigationChanged += TileView_NavigationChanged; // ПРАВИЛЬНОЕ ИМЯ
                //}

                newView.DataContext = managerToUse.State.DataContext ?? this.DataContext;
                controlToUse.Content = newView;
                UnsubscribeFromTileViewEvents(controlToUse); // ПРАВИЛЬНОЕ ИМЯ
            }
        ...
        private void TileView_NavigationChanged(object sender, EventArgs e) // ПРАВИЛЬНОЕ ИМЯ
        {
        ...
        private void UnsubscribeFromTileViewEvents(ContentControl control) // ПРАВИЛЬНОЕ ИМЯ
        {
            if (control?.Content is TileViewIcons tileViewIcons)
            {
                tileViewIcons.NavigationChanged -= TileView_NavigationChanged; // ПРАВИЛЬНОЕ ИМЯ
            }
