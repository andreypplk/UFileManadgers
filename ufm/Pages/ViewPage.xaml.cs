...
//        {
//            BreadcrumbBar.ItemsSource = new List<BreadcrumbItem>();
//        }
...
//        {
//            Debug.WriteLine($"[ViewPage] SetActivePanel: index={panelIndex}");
...
//            var items = UpdateBreadcrumbBar(_activePanelManager.CurrentPath);
//            _ = LoadBreadcrumbChildrenAsync(items);

//            Debug.WriteLine($"[ViewPage] SetActivePanel: calling _treePanel.SelectPath({_activePanelManager.CurrentPath})");
...
//            var items = UpdateBreadcrumbBar(_activePanelManager?.CurrentPath ?? "MyComputer");
//            _ = LoadBreadcrumbChildrenAsync(items);
//            Debug.WriteLine($"[ViewPage] Loaded. Active panel path: {_activePanelManager?.CurrentPath}");
//        }
...
//        {
//            Debug.WriteLine($"[ViewPage] OnTreeNavigateRequested: path={path}");
//            if (path == "MyComputer" || path == "SpecialFolders" || path == "Drives")
//            {
//                var items = UpdateBreadcrumbBar(path);
//                _ = LoadBreadcrumbChildrenAsync(items);
//                return;
//            }
...
//        {
//            Debug.WriteLine($"[ViewPage] OnLocalNavigationChanged: panelId={e.PanelId}, path={e.Path}");
//            if (e.PanelId == _activePanelManager?.PanelId)
//            {
//                var items = UpdateBreadcrumbBar(e.Path);
//                _ = LoadBreadcrumbChildrenAsync(items);
...
//            if (panel != null)
//            {
//                var items = UpdateBreadcrumbBar(panel.CurrentPath);
//                _ = LoadBreadcrumbChildrenAsync(items);
...
//        {
//            if (args.Item is BreadcrumbItem item && item.Tag is string targetPath)
//            {
//                Debug.WriteLine($"[ViewPage] Breadcrumb clicked: {targetPath}");
//                _activePanelManager?.NavigateTo(targetPath);
//            }
//        }
...
//        private void CopyButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Copy clicked");
//        private void PasteButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Paste clicked");
//        private void CutButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Cut clicked");
//        private void DeleteButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Delete clicked");
//        private void RenameButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Rename clicked");
//        private void MoveButton_Click(object sender, RoutedEventArgs e) => Debug.WriteLine("Move clicked");
...
//            {
//                case ViewMode.Icons:
//                    var tileViewerIcons = new TileViewerContent
//                    {
//                        PanelId = managerToUse.PanelId,
//                        DisplayMode = "Vertical"
//                    };
//                    tileViewerIcons.SetPanelManager(managerToUse);
//                    tileViewerIcons.NavigationChanged += TileView_NavigationChanged;
//                    newView = tileViewerIcons;
//                    break;
//                case ViewMode.List:
//                    var tileViewerList = new TileViewerContent
//                    {
//                        PanelId = managerToUse.PanelId,
//                        DisplayMode = "Horizontal"
//                    };
//                    tileViewerList.SetPanelManager(managerToUse);
//                    tileViewerList.NavigationChanged += TileView_NavigationChanged;
//                    newView = tileViewerList;
//                    break;
//                    // Остальные режимы пока не реализованы
//            }
//            if (newView != null)
//            {
...
//        // ================= Хлебные крошки =================
//        private List<BreadcrumbItem> UpdateBreadcrumbBar(string path)
//        {
...
//                    Icon = (path == "MyComputer" || path == "Drives") ? Symbol.OutlineStar : Symbol.Folder,
//                    Tag = path
//                });
//            }
...
//                    Symbol icon = (part.Length == 3 && part.EndsWith(":\\")) ? Symbol.OutlineStar : Symbol.Folder;

//                    var lastItem = items.LastOrDefault();
//                    if (lastItem == null || lastItem.Tag?.ToString() != part)
//                    {
//                        items.Add(new BreadcrumbItem
//                        {
//                            Text = displayName,
...
//        private async Task LoadBreadcrumbChildrenAsync(List<BreadcrumbItem> items)
//        {
...
//                    {
//                        var drives = await _fileSystemService.LoadDrivesAsync(
//                            new DirectoryHistory("MyComputer", "Мой Компьютер"));
//                        item.Items = drives.Select(d => new BreadcrumbItem
//                        {
//                            Text = d.Name,
//                            Icon = Symbol.OutlineStar,
//                            Tag = d.FilePath
...
//                    {
//                        var folders = await _fileSystemService.LoadFoldersOnlyAsync(
//                            targetPath, new DirectoryHistory(targetPath, targetPath));
//                        item.Items = folders.Select(f => new BreadcrumbItem
//                        {
//                            Text = f.Name,
//                            Icon = Symbol.Folder,
//                            Tag = f.FilePath
...
//            {
//                Debug.WriteLine($"[ViewPage] Breadcrumb clicked: {item.FullPath}");
...
//            CustomBreadcrumb.ItemsSource = items; // устанавливаем немедленно
...
//            await LoadBreadcrumbChildrenAsync(items);
//        }
...
//                try
//                {
//                    if (item.FullPath == "MyComputer" || item.FullPath == "Drives")
//                    {
...
//                    if (targetPath == "MyComputer")
//                    {
//                        var history = new DirectoryHistory("MyComputer", "Мой Компьютер");
...
//            // Обновляем источник, чтобы контрол перестроился и увидел Children
//            CustomBreadcrumb.ItemsSource = new ObservableCollection<CustomBreadcrumbItem>(items);
//        }
//        #endregion
//    }
//}
