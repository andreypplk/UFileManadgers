...
//        // NEW: отслеживаем активный TileViewerContent для состояния кнопок
...
//            // NEW: переподписываемся на новый активный TileViewerContent
...
//            // NEW: переподписываемся на выделение в новой активной панели
//            RefreshActiveTileViewer();
//        }
...
//            // NEW: начальная синхронизация состояния кнопки Rename
//            RefreshActiveTileViewer();
//        }
...
//            // NEW: отписываемся от активного TileViewerContent
...
//            // NEW: при смене источника обновляем подписку на выделение
//            RefreshActiveTileViewer();
//        }
...
//        // CHANGED: Rename теперь вызывает прямой метод без эмуляции F2
//        private void RenameButton_Click(object sender, RoutedEventArgs e)
//        {
//            _activeTileViewer?.RenameSelectedItem();
//        }
...
//            // NEW: после смены представления переподключаемся к новому TileViewerContent
//            RefreshActiveTileViewer();
//        }
...
//        #region NEW: TileViewer selection tracking and Rename button state
//        /// <summary>
//        /// Подписывается на событие SelectionStateChanged текущего активного TileViewerContent.
//        /// </summary>
...
//            // Получаем внутреннее состояние выделения через рефлексию,
//            // чтобы не хранить дублирующее поле (можно заменить на кеширование bool)
//            var itemsControlField = typeof(TileViewerContent).GetField("_currentItemsControl",
//                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
//            var itemsControl = itemsControlField?.GetValue(_activeTileViewer) as ListViewBase;

//            if (itemsControl != null)
//                RenameButton.IsEnabled = itemsControl.SelectedItems.Count > 0;
//            else
//                RenameButton.IsEnabled = false;
//        }
//        #endregion
...
//        // Оптимизированная вставка – без вызова RefreshActivePanel
//        private async void PasteButton_Click(object sender, RoutedEventArgs e)
//        {
//            if (_activeTileViewer != null)
//                await _activeTileViewer.PasteItemsAsync();
...
//        //// Оптимизированное удаление – без вызова RefreshActivePanel
//        //private async void DeleteButton_Click(object sender, RoutedEventArgs e)
//        //{
//        //    if (_activeTileViewer != null)
//        //        await _activeTileViewer.DeleteSelectedItemsAsync();
...
//        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
//        {
//            if (_activeTileViewer == null || !_activeTileViewer.HasSelection)
//                return;

//            // Получаем диалог из ресурсов текущей страницы (или из App.Current.Resources)
//            ContentDialog deleteDialog;
//            if (this.Resources.TryGetValue("DeleteConfirmationDialog", out var resource) && resource is ContentDialog dlg)
//            {
//                deleteDialog = dlg;
//            }
//            else
//            {
//                // fallback: создадим на месте (если ресурс не найден)
...
//            deleteDialog.XamlRoot = this.XamlRoot;   // обязательно в WinUI 3
...
//        private async void ViewPage_Loaded(object sender, RoutedEventArgs e)
//        {
//            // Передаём HWND главного окна (для тёмной темы диалогов)
//            if (_fileOperationService is FileOperationService fos)
//            {
//                var hwnd = WindowNative.GetWindowHandle(App.MainWindow);
//                fos.SetParentWindow(hwnd);
//            }
//            LoadAllPanelStates();
...
//            {
//                EnsureDeleteConfirmationDialog();
//                _deleteConfirmationDialog.XamlRoot = this.XamlRoot;
//                var result = await _deleteConfirmationDialog.ShowAsync();
//                if (result == ContentDialogResult.Primary && _activeTileViewer != null)
//                    await _activeTileViewer.DeleteSelectedItemsAsync();
//            }
//            finally
//            {
...
namespace ufm
{
    public sealed partial class ViewPage : Page
    {
        ...
        private async void ViewPage_Loaded(object sender, RoutedEventArgs e)
        {
            // Передаём дескриптор главного окна в сервис (для тёмной темы диалогов)
            if (_fileOperationService is FileOperationService fos)
            {
                var mainWindow = App.MainWindow;
                var hwnd = WinRT.Interop.WindowNative.GetWindowHandle(mainWindow);
                var dispatcher = mainWindow.DispatcherQueue;
                fos.Initialize(hwnd, dispatcher);
            }
        ...
        private async void OnDeleteRequested(object sender, EventArgs e)
        {
            ...
            try
            {
                // Диалог подтверждения временно отключён
                if (_activeTileViewer != null)
                    await _activeTileViewer.DeleteSelectedItemsAsync();
            }
            finally
