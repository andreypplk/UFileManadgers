...
//        private bool _isTreeDropProcessing = false; // защита от повторного входа
...
//        {
//            Debug.WriteLine("[TreePanel] Constructor called");
...
//            Debug.WriteLine("[TreePanel] Constructor finished");
//        }

//        private void LoadDefaultExpandedState()
//        {
//            Debug.WriteLine("[TreePanel] LoadDefaultExpandedState called");
//            try
//            {
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] LoadDefaultExpandedState error: {ex.Message}");
//                _savedExpandedPaths.Clear();
...
//            }
//            Debug.WriteLine("[TreePanel] LoadDefaultExpandedState finished");
//        }

//        private void TreePanelPg01_Unloaded(object sender, RoutedEventArgs e)
//        {
//            Debug.WriteLine("[TreePanel] Unloaded called");
//            _savedExpandedPaths.Clear();
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] Unloaded error: {ex.Message}");
//            }
//        }

//        public void Dispose()
//        {
//            Debug.WriteLine("[TreePanel] Dispose called");
//            if (!_disposed)
//            {
//                try
//                {
...
//                catch (Exception ex)
//                {
//                    Debug.WriteLine($"[TreePanel] Dispose error: {ex.Message}");
//                }
//                finally
//                {
//                    Instance = null;
...
//                }
//            }
//            Debug.WriteLine("[TreePanel] Dispose finished");
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] GetTargetFolder called, returning '{_currentTargetFolder}'");
//            return _currentTargetFolder;
//        }
//        #endregion
...
//            {
//                Debug.WriteLine($"[TreePanel] AddExpandedPath adding '{item.FilePath}'");
...
//        {
//            Debug.WriteLine($"[TreePanel] RestoreExpandedState called for '{treeName}', nodes count = {nodes?.Count ?? 0}");
...
//                    {
//                        Debug.WriteLine($"[TreePanel] RestoreExpandedState expanding node '{item.FilePath}'");
//                        tree.Expand(node);
//                    }
//                }
//                RestoreExpandedState(tree, node.Children, treeName + "->children");
//            }
//            Debug.WriteLine($"[TreePanel] RestoreExpandedState finished for '{treeName}'");
//        }
...
//        {
//            Debug.WriteLine("[TreePanel] Loaded called");
...
//                _isFirstLoad = false;
//            }
//            Debug.WriteLine("[TreePanel] Loaded finished");
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] SetSelectedRadioButton called with size '{selectedSize}'");
...
//            {
//                Debug.WriteLine($"[TreePanel] SizeRadioButton_Checked size='{selectedSize}'");
...
//        {
//            Debug.WriteLine("[TreePanel] TreeView_OnLoaded called");
...
//                }
//            });
//            Debug.WriteLine("[TreePanel] TreeView_OnLoaded finished");
//        }

//        private async Task PreloadFirstLevelAsync(TreeViewNode myComputerNode)
//        {
//            Debug.WriteLine($"[TreePanel] PreloadFirstLevelAsync: ChildrenCount before = {myComputerNode.Children.Count}");
...
//                        }
//                    }
//                    catch (Exception ex) { Debug.WriteLine($"[TreePanel] PreloadFirstLevelAsync error: {ex.Message}"); }
//                }
//            }
//            Debug.WriteLine($"[TreePanel] PreloadFirstLevelAsync: done");
//        }
...
//            Debug.WriteLine($"[TreePanel] Expanding MAIN: '{treeItem.FilePath}', HasUnrealized={args.Node.HasUnrealizedChildren}, ChildrenCount={args.Node.Children.Count}");

//            if (!args.Node.HasUnrealizedChildren)
//            {
//                Debug.WriteLine($"[TreePanel] Expanding MAIN: no unrealized children, skipping.");
//                return;
//            }
...
//                    Debug.WriteLine($"[TreePanel] Expanding MAIN: loaded drives, ChildrenCount={args.Node.Children.Count}");
//                    UpdateAllTiles();
//                }
//                else
//                {
...
//                    Debug.WriteLine($"[TreePanel] Expanding MAIN: loaded subfolders for '{treeItem.FilePath}', ChildrenCount={args.Node.Children.Count}");
//                    UpdateAllTiles();
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] Expanding MAIN error: {ex.Message}"); }
//        }

//        private void TreeView_OnDoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
//        {
//            Debug.WriteLine("[TreePanel] TreeView_OnDoubleTapped");
...
//        {
//            if (args.Node.Content is ExplorerItemViewModel item)
//                Debug.WriteLine($"[TreePanel] Collapsed MAIN: '{item.FilePath}', ChildrenCount={args.Node.Children.Count}");
//            // Не очищаем Children
//        }
...
//        {
//            Debug.WriteLine("[TreePanel] TreeViewSpF_OnLoaded called");
...
//            });
//            Debug.WriteLine("[TreePanel] TreeViewSpF_OnLoaded finished");
//        }

//        private async Task PreloadFirstLevelForSpFAsync(TreeViewNode specialFoldersNode)
//        {
//            Debug.WriteLine($"[TreePanel] PreloadFirstLevelForSpFAsync: ChildrenCount before = {specialFoldersNode.Children.Count}");
...
//                        }
//                    }
//                    catch (Exception ex) { Debug.WriteLine($"[TreePanel] PreloadFirstLevelForSpFAsync error: {ex.Message}"); }
//                }
//            }
//            Debug.WriteLine($"[TreePanel] PreloadFirstLevelForSpFAsync: done");
//        }
...
//            Debug.WriteLine($"[TreePanel] Expanding SpF: '{treeItem.FilePath}', HasUnrealized={args.Node.HasUnrealizedChildren}, ChildrenCount={args.Node.Children.Count}");

//            if (!args.Node.HasUnrealizedChildren)
//            {
//                Debug.WriteLine($"[TreePanel] Expanding SpF: no unrealized children, skipping.");
//                return;
//            }
...
//                    Debug.WriteLine($"[TreePanel] Expanding SpF: loaded home contents, ChildrenCount={args.Node.Children.Count}");
//                    _specialFolderPaths.Clear();
...
//                    Debug.WriteLine($"[TreePanel] Expanding SpF: loaded subfolders for '{treeItem.FilePath}', ChildrenCount={args.Node.Children.Count}");
//                    UpdateAllTiles();
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] Expanding SpF error: {ex.Message}"); }
...
//            {
//                Debug.WriteLine($"[TreePanel] LoadHomeContentsAsync: skipped, already has children ({parentNode.Children.Count})");
//                return;
//            }
//            Debug.WriteLine($"[TreePanel] LoadHomeContentsAsync: loading...");
//            try
//            {
//                parentNode.Children.Clear();
//                var homeItems = await _fileSystemService.LoadHomeAsync("TreeViewSpF", _historySpF);
//                Debug.WriteLine($"[TreePanel] LoadHomeContentsAsync: loaded {homeItems.Count} items");
...
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] LoadHomeContentsAsync error: {ex.Message}"); }
//            Debug.WriteLine($"[TreePanel] LoadHomeContentsAsync: after, ChildrenCount={parentNode.Children.Count}");
//        }

//        private void TreeViewSpF_OnCollapsed(TreeView sender, TreeViewCollapsedEventArgs args)
//        {
//            if (args.Node.Content is ExplorerItemViewModel item)
//                Debug.WriteLine($"[TreePanel] Collapsed SpF: '{item.FilePath}', ChildrenCount={args.Node.Children.Count}");
//            // Не очищаем Children
//        }

//        private void TreeViewSpF_OnDoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
//        {
//            Debug.WriteLine("[TreePanel] TreeViewSpF_OnDoubleTapped");
...
//        {
//            Debug.WriteLine($"[TreePanel] LoadDrivesSync: before, ChildrenCount={parentNode.Children.Count}");
//            try
//            {
//                parentNode.Children.Clear();
//                var driveItems = await _fileSystemService.LoadDrivesTree(_history);
//                Debug.WriteLine($"[TreePanel] LoadDrivesSync: loaded {driveItems.Count} drives from service");
...
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] LoadDrivesSync error: {ex.Message}"); }
//            Debug.WriteLine($"[TreePanel] LoadDrivesSync: after, ChildrenCount={parentNode.Children.Count}");
//        }

//        private async Task LoadSubfoldersAsync(TreeViewNode parentNode, string folderPath)
//        {
//            Debug.WriteLine($"[TreePanel] LoadSubfoldersAsync: '{folderPath}', before ChildrenCount={parentNode.Children.Count}");
//            try
//            {
//                parentNode.Children.Clear();
//                var folderItems = await _fileSystemService.LoadSubfoldersForTreeViewAsync(folderPath, _history);
//                Debug.WriteLine($"[TreePanel] LoadSubfoldersAsync: loaded {folderItems.Count} items");
...
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] LoadSubfoldersAsync error: {ex.Message}"); }
//            Debug.WriteLine($"[TreePanel] LoadSubfoldersAsync: after, ChildrenCount={parentNode.Children.Count}");
//        }

//        private async Task LoadSubfoldersForSpFAsync(TreeViewNode parentNode, string folderPath)
//        {
//            Debug.WriteLine($"[TreePanel] LoadSubfoldersForSpFAsync: '{folderPath}', before ChildrenCount={parentNode.Children.Count}");
//            try
//            {
//                parentNode.Children.Clear();
//                var folderItems = await _fileSystemService.LoadFoldersOnlyAsync(folderPath, _historySpF);
//                Debug.WriteLine($"[TreePanel] LoadSubfoldersForSpFAsync: loaded {folderItems.Count} items");
//                foreach (var item in folderItems)
//                {
//                    item.IsTreeViewNode = true;
//                    var node = new TreeViewNode { Content = item, HasUnrealizedChildren = true };
...
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] LoadSubfoldersForSpFAsync error: {ex.Message}"); }
//            Debug.WriteLine($"[TreePanel] LoadSubfoldersForSpFAsync: after, ChildrenCount={parentNode.Children.Count}");
//        }
...
//        {
//            Debug.WriteLine("[TreePanel] UpdateAllTiles called");
...
//        {
//            Debug.WriteLine("[TreePanel] ScheduleUpdateAllTiles");
...
//        {
//            Debug.WriteLine($"[TreePanel] FindItemByPath called for path '{path}'");
//            if (nodes == null) return null;
//            foreach (var node in nodes)
//            {
//                if (node?.Content is ExplorerItemViewModel item && NormalizePath(item.FilePath) == NormalizePath(path))
//                {
//                    Debug.WriteLine($"[TreePanel] FindItemByPath found '{item.FilePath}'");
//                    return item;
//                }
...
//        {
//            bool result = path == ".." || path == "Drives";
//            Debug.WriteLine($"[TreePanel] IsVirtualPath('{path}') = {result}");
//            return result;
//        }

//        private string NormalizePath(string path)
//        {
//            Debug.WriteLine($"[TreePanel] NormalizePath called for '{path}'");
...
//        {
//            Debug.WriteLine($"[TreePanel] OnNavigationChanged: PanelId={e.PanelId}, Path={e.Path}");
...
//        {
//            Debug.WriteLine($"[TreePanel] UpdateTreeViewSelection called: panelId={panelId}, path='{path}'");
//            try
//            {
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] UpdateTreeViewSelection error: {ex.Message}");
//            }
//            finally
//            {
//                _isNavigationChangingSelection = false;
...
//        {
//            Debug.WriteLine($"[TreePanel] EnsureMyComputerExpanded called");
//            if (myComputerNode?.Content is ExplorerItemViewModel item && item.FilePath == "MyComputer")
//            {
//                if (!myComputerNode.IsExpanded)
//                {
//                    Debug.WriteLine("[TreePanel] EnsureMyComputerExpanded: expanding MyComputer");
//                    treeView.Expand(myComputerNode);
//                }
//            }
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] EnsureSpecialFoldersExpanded called");
//            if (specialFoldersNode?.Content is ExplorerItemViewModel item && item.FilePath == "SpecialFolders")
//            {
//                if (!specialFoldersNode.IsExpanded)
//                {
//                    Debug.WriteLine("[TreePanel] EnsureSpecialFoldersExpanded: expanding SpecialFolders");
//                    treeViewSpF.Expand(specialFoldersNode);
//                }
//            }
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] ExpandNode: path='{path}', panelId={panelId}");
//            if (!node.HasUnrealizedChildren)
//                return;
...
//                await Task.Delay(20);
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] ExpandNode error: {ex.Message}"); }
//        }

//        private async Task<bool> ExpandAndSelectPath(IList<TreeViewNode> nodes, string[] pathSegments, int currentIndex, string panelId)
//        {
//            Debug.WriteLine($"[TreePanel] ExpandAndSelectPath: index={currentIndex}, segment='{pathSegments[currentIndex]}', panelId={panelId}");
...
//        {
//            Debug.WriteLine($"[TreePanel] FindNodeByItem called for target '{targetItem?.FilePath}'");
//            if (nodes == null) return null;
//            foreach (var node in nodes)
//            {
...
//        {
//            Debug.WriteLine("[TreePanel] ScrollToSelectedItem called");
...
//                });
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] ScrollToSelectedItem error: {ex.Message}"); }
//        }

//        private string[] SplitPath(string path)
//        {
//            Debug.WriteLine($"[TreePanel] SplitPath called for '{path}'");
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] SplitPath error: {ex.Message}");
//                return new[] { path };
//            }
//        }
...
//        {
//            Debug.WriteLine("[TreePanel] UpdateNavigationButtons called");
...
//                }
//                catch (Exception ex) { Debug.WriteLine($"[TreePanel] UpdateNavigationButtons error: {ex.Message}"); }
//            });
//        }

//        private void TreeViewSpF_SelectionChanged(TreeView sender, TreeViewSelectionChangedEventArgs args)
//        {
//            Debug.WriteLine("[TreePanel] TreeViewSpF_SelectionChanged called");
...
//        {
//            Debug.WriteLine("[TreePanel] TreeView_SelectionChanged called");
//            if (_isNavigationChangingSelection) return;
...
//        {
//            Debug.WriteLine("[TreePanel] BackButton_Click");
...
//        {
//            Debug.WriteLine("[TreePanel] ForwardButton_Click");
//            string activePanel = GetActivePanel();
...
//        {
//            Debug.WriteLine("[TreePanel] UpButton_Click");
//            try
//            {
//                if (!string.IsNullOrEmpty(_currentSelectedItemPath) && Directory.Exists(_currentSelectedItemPath))
//                {
...
//                }
//            }
//            catch (Exception ex) { Debug.WriteLine($"[TreePanel] UpButton_Click error: {ex.Message}"); }
//        }

//        private string GetActivePanel()
//        {
//            Debug.WriteLine($"[TreePanel] GetActivePanel returns '{_activePanelId ?? "MainTree"}'");
//            return _activePanelId ?? "MainTree";
//        }

//        private DirectoryHistory GetActiveHistory()
//        {
//            var history = GetActivePanel() == "SpFTree" ? _historySpF : _history;
//            Debug.WriteLine($"[TreePanel] GetActiveHistory current path = '{history?.Current?.DirectoryPath}'");
//            return history;
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] OnNavigateRequested: '{path}'");
//            NavigateRequested?.Invoke(this, path);
//        }

//        public void SelectPath(string path)
//        {
//            Debug.WriteLine($"[TreePanel] SelectPath called with '{path}'");
//            string panelId;
...
//        {
//            Debug.WriteLine($"[TreePanel] NavigateToPath called with '{path}'");
//            string panelId;
...
//            Debug.WriteLine($"[TreePanel] RefreshAfterDrop called. Sources: {paths.Count}, Target: '{targetPath}'");
...
//        {
//            Debug.WriteLine($"[TreePanel] RefreshNodeAfterFileOperation for '{folderPath}'");
//            _ = SyncTargetNodeAsync(folderPath);
//        }

//        private IEnumerable<ExplorerItemViewModel> GetSelectedItems(TreeView tree)
//        {
//            Debug.WriteLine("[TreePanel] GetSelectedItems called");
...
//        {
//            Debug.WriteLine($"[TreePanel] KeyDown: {e.Key}");
...
//            Debug.WriteLine($"[TreePanel] TreeView_DragItemsStarting. Source paths: {string.Join(", ", _lastDragSourcePaths)}");
...
//                Debug.WriteLine($"[TreePanel] TreeView_DragOver: target under pointer = '{target}'");
...
//                    Debug.WriteLine($"[TreePanel] TreeView_DragOver: no target under pointer, using selected path '{_currentSelectedItemPath}'");
//                }
//                else
//                {
//                    e.AcceptedOperation = DataPackageOperation.None;
//                    Debug.WriteLine("[TreePanel] TreeView_DragOver: no valid folder, rejecting drop");
//                    e.Handled = true;
//                    return;
//                }
//            }
...
//        {
//            Debug.WriteLine("[TreePanel] TreeView_Drop started");
//            if (_isTreeDropProcessing)
//            {
//                Debug.WriteLine("[TreePanel] TreeView_Drop: already processing, skipping");
//                return;
//            }
...
//                {
//                    Debug.WriteLine($"[TreePanel] TreeView_Drop: target folder does not exist, aborting");
//                    e.Handled = true;
//                    return;
//                }

//                // Извлекаем исходные пути
//                var sourcePaths = new List<string>();
//                if (e.DataView.Contains(StandardDataFormats.StorageItems))
//                {
//                    var storageItems = await e.DataView.GetStorageItemsAsync();
//                    sourcePaths = storageItems.Select(i => i.Path).Where(p => !string.IsNullOrEmpty(p)).ToList();
//                    Debug.WriteLine($"[TreePanel] TreeView_Drop: external source paths: {string.Join(", ", sourcePaths)}");
//                }

//                if (sourcePaths.Count > 0)
//                {
//                    // Выполняем операцию копирования/перемещения напрямую через FileOperationService
...
//                    Debug.WriteLine($"[TreePanel] TreeView_Drop: file operation completed ({(isMove ? "Move" : "Copy")})");
//                }

//                e.Handled = true;

//                // Обновляем исходные узлы (если перемещение) и целевой узел
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] TreeView_Drop error: {ex.Message}");
//            }
//            finally
//            {
//                _isTreeDropProcessing = false;
//                Debug.WriteLine("[TreePanel] TreeView_Drop finished");
//            }
//        }
...
//        //    var elements = VisualTreeHelper.FindElementsInHostCoordinates(point, tree);
//        //    foreach (var element in elements)
//        //    {
//        //        if (element is TreeViewItem tvi && tvi.DataContext is TreeViewNode node && node.Content is ExplorerItemViewModel item)
//        //        {
//        //            if (!string.IsNullOrEmpty(item.FilePath) && Directory.Exists(item.FilePath))
//        //            {
//        //                Debug.WriteLine($"[TreePanel] GetTargetFolderUnderPointer found: {item.FilePath}");
//        //                return item.FilePath;
//        //            }
//        //        }
//        //    }
//        //    Debug.WriteLine("[TreePanel] GetTargetFolderUnderPointer: no folder found");
//        //    return null;
//        //}
...
//            // Рекурсивный обход всех узлов (включая свёрнутые, если у них есть контейнеры)
...
//                        try
//                        {
//                            // Получаем координаты контейнера относительно TreeView
...
//                            }
//                        }
//                        catch { /* контейнер может быть не полностью загружен */ }
//                    }

//                    // Ищем в дочерних узлах (даже если узел не развёрнут, контейнеры дочерних всё равно не созданы, но на всякий случай)
//                    if (node.Children.Count > 0)
//                    {
...
//            Debug.WriteLine("[TreePanel] GetTargetFolderUnderPointer searching...");
//            var result = FindInNodes(tree.RootNodes);
//            if (result == null)
//                Debug.WriteLine("[TreePanel] GetTargetFolderUnderPointer: no folder found");
//            return result;
//        }
...
//        {
//            _modifierKeyService.UpdateKeyStateFromCore();
//            Debug.WriteLine("[TreePanel] TreeView_DragEnter");
//            e.Handled = true;
//        }
...
//        {
//            _modifierKeyService.UpdateKeyStateFromCore();
//            Debug.WriteLine("[TreePanel] TreeView_DragLeave");
//            e.Handled = true;
//        }
...
//            if (paths.Count == 0) return;
//            _lastDragSourcePaths = new List<string>(paths);
//            Debug.WriteLine($"[TreePanel] TreeViewSpF_DragItemsStarting. Source paths: {string.Join(", ", _lastDragSourcePaths)}");
//            _dragDropService.OnDragItemsStarting(paths, args);
//        }
...
//                Debug.WriteLine($"[TreePanel] TreeViewSpF_DragOver: target under pointer = '{target}'");
...
//                {
//                    _currentTargetFolder = _currentSelectedItemPath;
//                    Debug.WriteLine($"[TreePanel] TreeViewSpF_DragOver: no target under pointer, using selected path '{_currentSelectedItemPath}'");
//                }
//                else
//                {
//                    e.AcceptedOperation = DataPackageOperation.None;
//                    Debug.WriteLine("[TreePanel] TreeViewSpF_DragOver: no valid folder, rejecting drop");
//                    e.Handled = true;
//                    return;
//                }
//            }
...
//        {
//            Debug.WriteLine("[TreePanel] TreeViewSpF_Drop started");
//            if (_isTreeDropProcessing)
//            {
//                Debug.WriteLine("[TreePanel] TreeViewSpF_Drop: already processing, skipping");
//                return;
//            }
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] TreeViewSpF_Drop error: {ex.Message}");
//            }
//            finally
//            {
//                _isTreeDropProcessing = false;
...
//        {
//            _modifierKeyService.UpdateKeyStateFromCore();
//            Debug.WriteLine("[TreePanel] TreeViewSpF_DragEnter");
//            e.Handled = true;
//        }
...
//        {
//            _modifierKeyService.UpdateKeyStateFromCore();
//            Debug.WriteLine("[TreePanel] TreeViewSpF_DragLeave");
//            e.Handled = true;
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] RefreshSourceNodesAsync called with {sourcePaths?.Count ?? 0} source paths.");
//            if (sourcePaths == null || sourcePaths.Count == 0)
//                return;

//            foreach (var sourcePath in sourcePaths)
//            {
//                Debug.WriteLine($"[TreePanel] Checking source path: {sourcePath}");
//                if (!Directory.Exists(sourcePath) && !File.Exists(sourcePath))
//                {
//                    Debug.WriteLine($"[TreePanel]   Source path does not exist. Looking for parent node...");
//                    try
//                    {
//                        var parentPath = System.IO.Path.GetDirectoryName(sourcePath);
//                        if (string.IsNullOrEmpty(parentPath))
//                        {
//                            Debug.WriteLine($"[TreePanel]   Parent path is empty, skipping.");
//                            continue;
//                        }
//                        Debug.WriteLine($"[TreePanel]   Parent path: {parentPath}");
...
//                        if (parentItem != null)
//                        {
//                            Debug.WriteLine($"[TreePanel]   Found parent item in main treeView.");
...
//                            if (parentItem != null)
//                            {
//                                Debug.WriteLine($"[TreePanel]   Found parent item in treeViewSpF.");
//                                parentNode = FindNodeByItem(treeViewSpF.RootNodes, parentItem);
//                                childrenCollection = parentNode?.Children;
//                            }
//                            else
//                            {
//                                Debug.WriteLine($"[TreePanel]   Parent item not found in any tree.");
//                            }
//                        }

//                        if (childrenCollection != null)
//                        {
//                            Debug.WriteLine($"[TreePanel]   Parent children count before: {childrenCollection.Count}");
...
//                                {
//                                    nodeToRemove = child;
//                                    Debug.WriteLine($"[TreePanel]   Found node to remove: {childItem.FilePath}");
//                                    break;
//                                }
//                            }
...
//                                Debug.WriteLine($"[TreePanel]   Node removed. Children count after: {childrenCollection.Count}");
//                            }
//                            else
//                            {
//                                Debug.WriteLine($"[TreePanel]   Node to remove not found in children collection.");
//                            }
//                        }
//                    }
//                    catch (Exception ex)
//                    {
//                        Debug.WriteLine($"[TreePanel]   Exception during refresh: {ex.Message}");
//                    }
//                }
//                else
//                {
//                    Debug.WriteLine($"[TreePanel]   Source path still exists (copy? skip).");
//                }
//            }
//            Debug.WriteLine("[TreePanel] RefreshSourceNodesAsync finished.");
//        }
...
//        {
//            Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: syncing target '{targetPath}'");
...
//                if (item == null)
//                {
//                    Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: node not found for '{targetPath}'");
//                    return null;
//                }
...
//                {
//                    targetTree = treeView;
//                    Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: found node in main treeView");
//                }
//                else
//                {
...
//                        Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: found node in treeViewSpF");
//                    }
//                }

//                if (node == null || targetTree == null)
//                {
//                    Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: node or targetTree is null");
//                    return null;
//                }

//                Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: before - IsExpanded={node.IsExpanded}, ChildrenCount={node.Children.Count}");

//                // Загружаем актуальный список папок
...
//                // Удаляем дочерние узлы, которых больше нет на диске
...
//                    {
//                        Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: removing node '{childItem.FilePath}'");
//                        node.Children.RemoveAt(i);
//                    }
//                }

//                // Добавляем новые папки и запоминаем первый добавленный путь
...
//                        // Вставляем с сохранением алфавитного порядка
//                        int insertIndex = 0;
...
//                        Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync: inserted node '{vm.FilePath}' at index {insertIndex}");
//                    }
//                }
...
//                Debug.WriteLine($"[TreePanel] Target node synced: {targetPath}, ChildrenCount={node.Children.Count}");
//                return firstAddedPath;
//            }
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"[TreePanel] SyncTargetNodeAsync error: {ex.Message}");
//                return null;
//            }
//        }
