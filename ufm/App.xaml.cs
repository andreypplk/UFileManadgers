...
namespace ufm
{
    public partial class App : Application
    {
        ...
        public static FileOperationService FileOperationService { get; set; }

        private readonly List<DependencyObject> _elementsWithUid = new List<DependencyObject>();

        // ---------- P/Invoke для активации тёмного режима в системных диалогах ----------
        ...
        {
            // Разрешаем тёмный режим для системных диалогов (SHFileOperation и др.)
            ...
            // Инициализация глобального файлового сервиса с дескриптором главного окна
            FileOperationService = new FileOperationService();
            FileOperationService.Initialize(hWnd, MainWindow.DispatcherQueue);
